...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                <li class="menuLigneOne"> <a href="index.php#presentationSection">Acceuil</a> </li>
                <li class="menuLigneTwo"><a href="index.php#about">À propos</a></li>
                <li class="menuLigneThree"><a href="services.php#presentationServices">Mes services</a><img class="imgServiceHeader" src="assets/img/arrowHeader.png" alt="iconne qui donne accé au menu déroulan">
                </li>


                <li class="servicesNext"><img src="assets/img/serviceNextHeader.png" alt="sous menue, service de création de site web"><a href="services.php#websiteCreation">Conception et création de site web</a></li>
                <li class="servicesNext"><img src="assets/img/serviceNextHeader.png" alt="sous menue, service de de gestion et de maintenace de site web"><a href="services.php#pack">Gestion et maintenace de site web</a></li>
                <li class="servicesNext"><img src="assets/img/serviceNextHeader.png" alt="sous menue, service de sous-traintance"><a href="services.php#outsourcingoutsourcingSkill">Sous-traitance</a></li>



                <li class="menuLigneFour"><a href="index.php#contact">Contacts</a></li>
                <li class="menuLigneFive">
                    <div>
