...
<section id="websiteCreation">
        ...
        <div class="textImgWebsiteCreation">
            ...
            <div class="imgWebsiteCreation">
                ...
                <div class="imgWebsiteCreationTwo">
                    <img src="assets/img/serviceTow.jpg" alt="image d'écran d'écran d'ordinateur ou l'on consoit un design de site web">
                </div>
            </div>
        </div>
    </div>
    <div class="explanationWebsiteCreation">
        ...
        <div class="callToActionWebsiteCreation">
            <p>Des solutions <span>adaptées</span> à votre domaine d'activité ! Et un tarif adapté à un site internet de <span>qualité</span> !</p>
